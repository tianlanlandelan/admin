package com.yangkaile.admin.proxy.controller;

import com.yangkaile.admin.common.encryption.MyBase64Utils;
...
import com.yangkaile.admin.common.util.JsonUtils;
import com.yangkaile.admin.common.util.StringUtils;
import com.yangkaile.admin.proxy.cache.CacheUtils;
...
public class ApiController {
    ...
    public ResponseEntity get(String methodName, String parameters){
        ...
        try{
            ...
            return CacheUtils.getResponseFromException(e);
        }catch (Exception e){
            return MyResponse.badRequest();
        }
    ...
    private String authenticateAndReturnRouterUrl(String requestType,String methodName){
        ...
        MyRouter routerObject = CacheUtils.getRouterMap().get(methodName);
        /*
         * 拿不到路由
         */
